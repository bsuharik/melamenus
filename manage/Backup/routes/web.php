...
//Route::get('/auth/facebook/callback', 'HomeController@handleFacebookCallback');
//Route::get('/auth/google', 'HomeController@redirectToGoogle');
//Route::get('/auth/google/callback', 'HomeController@handleGoogleCallback');

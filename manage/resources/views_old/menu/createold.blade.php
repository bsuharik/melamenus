                ...
                <div class=" col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="cloned_menu_image">
                                <label id="other_display_image"><b>Menu Other Image </b></label>
                            </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <input type="hidden" name="delete_element_image" id="delete_element_image">
                        </div>
                    </div>
                </div>
            </div>
...
$(document).ready(function (e) {
    ...
    $(menu_image_add_button).click(function(e){ //on add input button click
        ...
        if(image_count < menu_max_fields){ 
            ...
            $(menu_image_wrapper).append('<div class="col-sm-12 count_menu_other_image">\
                                                ...
                                                <div id="errorMessage"></div>\
                                                <div class="col-md-1">\
                                                    <button id="remove_field_image" type="button" class="btn btn-primary" data-toggle="modal" data-target="#deleteImageModal" data-class="remove_field_image'+menu_x+'" style="float:right;">-</button>\
                                                </div>\
    ...
    $(document).ready(function() {
        ...
        var span = $('<span />').text(tags_placeholder).appendTo(tags_active);
        ...
        var span = $('<span />').text(allergies_placeholder).appendTo(allergies_active);

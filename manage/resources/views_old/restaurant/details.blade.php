            ...
            <div class="collapse navbar-collapse justify-content-between">
                <div class="header-left">
                    <div class="dashboard_bar">
                        Restaurant Owner - {{ $restaurant->restaurant_name }}
                    </div>
                </div> 
                    ...
                    <div class="card-body">
                        ...
                        <div class="row"> 
                            <div class="col-sm-12 text-right">
                                ...
                                @if($user_type == "0")
                                    <a href="{{ url('restaurant') }}" id="back_button" class="btn btn-info btn-block back-btn-new">Back</a>
                                @else
                                    @if(Auth::user()->id != $restaurant->restaurant_id)
                                        @if(!empty(Auth::user()->restaurant_owner_id))
                                            <a href="{{ url('home') }}" id="back_button" class="btn btn-info btn-block back-btn-new">Back</a>
                                        @else
                                            <a href="{{ url('users') }}" id="back_button" class="btn btn-info btn-block back-btn-new">Back</a>
                                        @endif
                            ...
                            <div class="profile card card-body px-3 pt-3 pb-0" style="padding-top: 0px !important;">
                                <div class="profile-head brand-cover-photo" >
                                    <div class="brand-maincover-pic">
                                        <?php
                                            if($user_type == "0"){
                                                $restaut_cover_src= '../'.config('images.restaurant_url') .$restaurant->restaurant_id.'/'. $restaurant->restaurant_cover_image;
                                                $restaurant_default_banner='../'.config('images.restaurant_default_banner_url');
                                                $restaurant_logo_src='../'.config('images.restaurant_url') .$restaurant->restaurant_id.'/'. $restaurant->restaurant_logo;
                                                $restaurant_default_logo='../'.config('images.default_image_url');
                                            }else{
                                        ...
                                        @if(!empty($restaurant->restaurant_cover_image))
                                             <img src="{{$restaut_cover_src}}" class="brand-banner-img" alt=""> 
                                        @else 
                                            <img src="{{$restaurant_default_banner}}" class="brand-banner-img" alt="">     
                                        @endif
                                    </div>  
                                    ...
                                    <div class="profile-info">
                                        <div class="profile-photo" style="margin-top: 0px;"> 
                                            @if(!empty($restaurant->restaurant_logo))
                                                <img src="{{$restaurant_logo_src}}" class="img-fluid" alt="">
                                            @else
                                                <img src="{{$restaurant_default_logo}}" class="img-fluid" alt="">
                                            @endif
                                        </div>
                                        <div class="profile-details">
                                            <div class="profile-name px-3 pt-3">
                                                <h4 class="text-primary mb-0">{{ $restaurant->restaurant_name }}</h4>
                                            </div>
                                            <div class="dropdown ml-auto">
                                                <a href="#" class="btn btn-primary light sharp" data-toggle="dropdown" aria-expanded="true"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18px" height="18px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"></rect><circle fill="#000000" cx="5" cy="12" r="2"></circle><circle fill="#000000" cx="12" cy="12" r="2"></circle><circle fill="#000000" cx="19" cy="12" r="2"></circle></g></svg></a>
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <a href="{{ url('/restaurant_profile/') }}/{{ $restaurant->restaurant_id }}"><li class="dropdown-item"><i class="fa fa-user-circle text-primary mr-2"></i> Edit profile</li></a>
                                                    <!-- <li class="dropdown-item"><i class="fa fa-user-circle text-primary mr-2"></i> <a href="#">Select Theme</a></li> -->
                                                </ul>
                                            </div>                                 
                                        </div>
                                    </div>
                                            ...
                                            <div class="profile-personal-info">
                                                ...
                                                <div class="row mb-2">
                                                    ...
                                                    <div class="col-9"><span>
                                                        @if(!empty($restaurant->user_detail->first_name)){{ $restaurant->user_detail->first_name}}@endif</span>
                                                    </div>
                                                </div>
                                                <div class="row mb-2">
                                                     <div class="col-3">
                                                    ...
                                                    <div class="col-9"><span>@if(!empty($restaurant->user_detail->last_name)){{ $restaurant->user_detail->last_name }}@endif</span>
                                                    </div>
                                                </div>
                                                <div class="row mb-2">
                                                    <div class="col-3">
                                                    ...
                                                    <div class="col-9"><span>{{ $restaurant->email }}</span>
                                                    </div>
                                                </div>
                                                <div class="row mb-2">
                                                    <div class="col-3">
                                                    ...
                                                    <div class="col-9"><span>{{ $restaurant->contact_number }}</span>
                                                    </div>
                                                </div>  
                                                <div class="row mb-2">
                                                    <div class="col-3">
                                                    ...
                                                    <div class="col-9"><span>{{ $restaurant->contact_person }}</span>
                                                    </div>
                                                </div>                                                  
                                                <div class="row mb-2">
                                                    <div class="col-3">
                                                    ...
                                                    <div class="col-9"><span>{{ $country_name }}</span>
                                                    </div>
                                                </div>
                                                <div class="row mb-2">
                                                    <div class="col-3">
                                                    ...
                                                    <div class="col-9"><span>{{ $restaurant->location }}</span>
                                                    </div>
                                                </div>
                                                <div class="row mb-2">
                                                    <div class="col-3">
                                                    ...
                                                    <div class="col-9"><span>{{ $currency_name }}</span>
                                                    </div>
                                                </div>
                                                {{-- <div class="row mb-2">
                                                    <div class="col-3">
                                                    ...
                                                    <div class="col-9">
                                                        <span>
                                                            @if(!empty($restaurant->user_detail))
                                                            @if($restaurant->user_detail->gender == "0")
                                                                Male
                                                            @elseif($restaurant->user_detail->gender == "1")
                                                                Female
                                                            @elseif($restaurant->user_detail->gender == "2")
                                                                Other
                                                            @endif
                                                            @endif
                                                        </span>
                                                ...
                                                <div class="row mb-2">
                                                    ...
                                                    <div class="col-9">
                                                        <span>
                                                            @if(!empty($restaurant->user_detail->date_of_birth))
                                                                {{ date('d-m-Y',strtotime($restaurant->user_detail->date_of_birth)) }}
                                                            @endif
                                                        </span>
                                                    </div>
                                                </div>

    ...
    <link href="{!! asset('theme/admin/css/crop-image/imgareaselect.css') !!}" rel="stylesheet">
    <style>
#uploadPreview {
                ...
                <div class="collapse navbar-collapse justify-content-between">
                    <div class="header-left">
                        <div class="dashboard_bar">  
                            {{ $restaurant->restaurant_name }} - Edit Profile DetailsOLD1
                        </div>
                    </div>
    ...
    ***********************************-->
    <div class="content-body">
        <div class="container-fluid">
            <form method="POST" enctype="multipart/form-data" id="update_restaurant_profile" action="javascript:void(0)" files="true">
                <input type="hidden" name="crop_cover_img" id="crop_cover_img" value="">
                <!-- row -->
                <div class="row">                
                    <div class="col-xl-12">
                        <div class="card">
    ...
    <!-- Crop image model start -->
        <div class="modal fade" id="crop_imageModal">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="fontErrorMessage"></div>
                    <form method="POST" id="add_crop_image" action="javascript:void(0)" enctype="multipart/form-data" files="true">
                        <input type="hidden" name="restaurant_id" value="{{ $restaurant->restaurant_id }}"/>
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <img id="filePreview" src="" class="brand-banner-img crop_img" alt="">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger light" data-dismiss="modal">Close</button>
                            <input type="submit" name="submit" value="Crop Image" class="btn btn-primary">
                        </div>
                    </form>
                </div>
            </div>
    ...
    ***********************************-->
    ...
    <script src="{!! asset('theme/admin/js/crop-image/jquery.imgareaselect.js') !!}"></script>
    ...
    $(document).ready(function (e){ 
        ...
        // cover image check size image js Start
        $("#restaurant_cover_image").on('change', function() {
            // var fileUpload= document.getElementById("restaurant_cover_image").files[0];
            var fileUpload = $("#restaurant_cover_image")[0];
                ...
                if (typeof (fileUpload.files) != "undefined") {
                    ...
                    reader.onload = function (e) {
                        ...
                        image.onload = function () {
                            ...
                            //     return false;
                            // }
                            if ((height >= 300 || height <= 200) && (width >= 1100 || width <= 1400)) {
                                alert("Height and Width must not exceed 200*1400.");
                                return false;
                            }
        ...
        // cover image check size image js End

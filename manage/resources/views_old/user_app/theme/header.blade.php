            ...
            @endif
                <div class="container"> 
                    ...
                    <div class="panel-control-right panel-control-right_main drop_new_lag_cry"> 
                        <!-- Language Change -->
                        <a href="javascript::void();" id="open_popup"><i class="fa fa-globe" id="fa_globe"></i></a>
                    </div>
                </div>
            </div> 
            <div class="form-popup new_popup " id="myForm">
                ...
                <form method="POST" enctype="multipart/form-data" id="change_language_currency" action="javascript:void(0)" files="true" class="form-container">
                    <div class="row mb0">
                        ...
                        <select class="form-control" id="change_language" name="change_language">
                        <option value="">Select</option>
                            @if(!empty($language_list)) 
                                @foreach($language_list as $language)
                                    <option data-lang="{{$language->short_name}}" data-href="#googtrans(en|{{$language->short_name}})" value="{{$language->id}}"
                        ...
                        <div class="form-control">
                            <a href="javascript::void()" id="default_language_currency" class="btn button">Default</a>
                        </div>

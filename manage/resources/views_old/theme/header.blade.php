...
<head>
    ...
    <!-- Time Picker -->
    <link href="{!! asset('theme/admin/css/Timepicker/jquery.timepicker.css') !!}" rel="stylesheet">
</head>
<body>
    <div id="myHtml" style="width: 400px; margin:20px; padding:25px; display: none;" ></div>
    <?php  //echo "here"; exit(); ?>
    <!--*******************
        Preloader start
    ********************-->

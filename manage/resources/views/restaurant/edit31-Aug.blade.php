            ...
            <div class="collapse navbar-collapse justify-content-between">
                <div class="header-left">
                    <div class="dashboard_bar">  
                        {{ $restaurant->restaurant_name }} - Edit Profile Detailsaug31
                    </div>
                </div>
                                                ...
                                                <div class="profile-personal-info">
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-md-5 error_message_parent">
                                                            <select name="texture_image" class="form-control" id="texture_image">
                                                                <option value="">Select Texture Image</option>
                                                                @if(!empty($texture_array))
                                                                @foreach($texture_array as $texture_list)
                                                                <option data-img_src="../{{ config('images.texture_url') . $texture_list->image }}" value="{{$texture_list->id}}" {{ ($restaurant->texture_id == $texture_list->id) ? 'selected' : '' }} >{{$texture_list->image}}</option>
                                                                @endforeach
                                                                @endif

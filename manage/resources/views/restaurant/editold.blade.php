            ...
            <div class="collapse navbar-collapse justify-content-between">
                <div class="header-left">
                    <div class="dashboard_bar">  
                        {{ $restaurant->restaurant_name }} - Edit Profile Detailseditold
                    </div>
                </div>
                                        ...
                                        <div id="my-posts" class="tab-pane fade active show">
                                            <div class="my-post-content pt-3">
                                                <div class="profile-personal-info">
                                                    ...
                                                    <!-- <div class="row form-group">
                                                        <div class="col-md-2">
                                                            <label id="custom-label">Color:  </label>
                                                        </div>
                                                        <div class="col-md-10 error_message_parent">
                                                        </div>
                                                    </div> -->
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col">
                                                           ...
                                                           <select name="app_theme_font_type_1" class="form-control" id="app_theme_font_type_1">
                                                                ...
                                                                <option value="Arial" {{ ( $restaurant->app_theme_font_type_1 == 'Arial') ? 'selected' : '' }} >Arial</option>
                                                                <option value="Calibri" {{ ( $restaurant->app_theme_font_type_1 == 'Calibri') ? 'selected' : '' }} >Calibri</option>
                                                                <option value="Cambria " {{ ( $restaurant->app_theme_font_type_1 == 'Cambria ') ? 'selected' : '' }}>Cambria </option>
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <select name="app_theme_font_type_2" class="form-control" id="app_theme_font_type_2">
                                                                <option value="">Select</option>
                                                                <option value="Arial" {{ ( $restaurant->app_theme_font_type_2 == 'Arial') ? 'selected' : '' }} >Arial</option>
                                                                <option value="Calibri" {{ ( $restaurant->app_theme_font_type_2 == 'Calibri') ? 'selected' : '' }} >Calibri</option>
                                                                <option value="Cambria " {{ ( $restaurant->app_theme_font_type_2 == 'Cambria ') ? 'selected' : '' }}>Cambria </option>
                                                        ...
                                                        <div class="col">
                                                            <select name="app_theme_font_type_3" class="form-control" id="app_theme_font_type_3">
                                                                <option value="">Select</option>
                                                                <option value="Arial" {{ ( $restaurant->app_theme_font_type_3 == 'Arial') ? 'selected' : '' }} >Arial</option>
                                                                <option value="Calibri" {{ ( $restaurant->app_theme_font_type_3 == 'Calibri') ? 'selected' : '' }} >Calibri</option>
                                                                <option value="Cambria " {{ ( $restaurant->app_theme_font_type_3 == 'Cambria ') ? 'selected' : '' }}>Cambria </option>
                                                        ...
                                                        <div class="col">
                                                             <select name="app_theme_font_type_4" class="form-control" id="app_theme_font_type_4">
                                                                <option value="">Select</option>
                                                                <option value="Arial" {{ ( $restaurant->app_theme_font_type_4 == 'Arial') ? 'selected' : '' }} >Arial</option>
                                                                <option value="Calibri" {{ ( $restaurant->app_theme_font_type_4 == 'Calibri') ? 'selected' : '' }} >Calibri</option>
                                                                <option value="Cambria " {{ ( $restaurant->app_theme_font_type_4 == 'Cambria ') ? 'selected' : '' }}>Cambria </option>

                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
                            <div class="dashboard_bar">
                                {{ $restaurant->restaurant_name }} - Edit Profile Details3
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="profile-tab">
                                        <div class="profile card card-body px-3 pt-3 pb-0" style="padding-top: 0px !important;">
                                            <div class="profile-head brand-cover-photo">
                                                <div class="brand-maincover-pic">
                                                    <div id="timelineBackground">
                                                        <img src="" id="timelineBGload" class="headerimage ui-corner-all brand-banner-img" style="top:0px; display: none"/>';
                                                        @if(!empty($restaurant->restaurant_cover_image)) 
                                                            <img src="../{{ config('images.restaurant_url') .$restaurant->restaurant_id.'/'. $restaurant->restaurant_cover_image }}" class="brand-banner-img banner_img" alt="Restaurant Cover Image" style="top: {{$restaurant->cover_img_position}};">   
                                                        @else
                                                    ...
                                                    <div class="profile-details">
                                                        ...
                                                        <div class="advertisement-banner ml-auto">
                                                            <div class="error_message_parent" style="margin-top: 0px;">
                                                                ...
                                                                <span id="errorMessage"></span>
                                                                <input name="restaurant_cover_image" class="file-upload_banner profile_banner" type="file" id="restaurant_cover_image" accept="image/*" />
                                            ...
                                            <small style="color:red;font-size:111% ;display:none" id="cover_img_msg"></small>
                                        </div>

                ...
                <div class="footer_menu">
                    <ul >
                        ...
                        Launch demo modal
                            ...
                            <a href="javascript::void();" data-open='0' id="searchPopup" data-target="#exampleModal" data-toggle="modal" style="color:<?=$restaurant_details->app_theme_color_1;?>;"><i class="fa fa-search" id="fa_search"></i> Search</a>
                        </li>
                        <li class="{{ Request::is('user_home/*') ? 'active' : '' }}">
                            <a href="{{ url('user_home') }}/{{ $restaurant_details->restaurant_id}}" style="color:<?=$restaurant_details->app_theme_color_1;?>;"><i class="fa fa-home"></i> Home </a>
                        </li>

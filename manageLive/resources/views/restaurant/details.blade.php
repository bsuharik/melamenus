                                ...
                                <div class="profile-head">                               
                                    <div class="profile-info">
                                        <div class="profile-photo" style="margin-top: 0px;">
                                            <img src="../{{ config('images.restaurant_url') .$restaurant->restaurant_id.'/'. $restaurant->restaurant_logo }}" class="img-fluid" alt="">
                                        </div>
                                        ...
                                        <div class="my-post-content pt-3">
                                            <div class="profile-personal-info">
                                                ...
                                                <div class="row mb-2">
                                                    ...
                                                    <div class="col-9"><span>{{ $restaurant->first_name }}</span>
                                                    </div>
                                                </div>
                                                <div class="row mb-2">
                                                    <div class="col-3">
                                                    ...
                                                    <div class="col-9"><span>{{ $restaurant->last_name }}</span>
                                                    </div>
                                                </div>
                                                <div class="row mb-2">
                                                    <div class="col-3">
                                                ...
                                                <div class="row mb-2">
                                                    ...
                                                    <div class="col-9">
                                                        <span>
                                                            @if($restaurant->gender == "0")
                                                                Male
                                                            @elseif($restaurant->gender == "1")
                                                                Female
                                                            @elseif($restaurant->gender == "2")
                                                                Other
                                                            @endif
                                                        </span>
                                                    </div>
                                                ...
                                                <div class="row mb-2">
                                                    ...
                                                    <div class="col-9">
                                                        <span>
                                                            @if($restaurant->date_of_birth != "")
                                                                {{ date('d-m-Y',strtotime($restaurant->date_of_birth)) }}
                                                            @endif
                                                        </span>
                                                    </div>
                                                </div>

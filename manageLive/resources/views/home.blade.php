...
<div class="content-body">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-6 col-lg-4 col-sm-8">
                <div class="card overflow-hidden">
                    <div class="card-header media border-0 pb-0">
                        <div class="media-body">
                            <h2 class="text-black">{{ $restaurant_count }} </h2>
                            <p class="mb-0 text-black">Total Restaurants</p>
                        </div>
            ...
            <!--div class="col-xl-4 col-lg-4 col-sm-8">
                <div class="card overflow-hidden">
                    <div class="card-header media border-0 pb-0">
                        <div class="media-body">
                            <h2 class="text-black">85 </h2>
                            <p class="mb-0 text-black">Total Category</p>
                        </div>
            ...
            <div class="col-xl-6 col-lg-4 col-sm-8">
                <div class="card overflow-hidden">
                    <div class="card-header media border-0 pb-0">
                        <div class="media-body">
                            <h2 class="text-black">{{ count($tables) }}</h2>
                            <p class="mb-0 text-black">Total Tables</p>
                        </div>
            ...
            <div class="col-xl-12 col-xxl-12 col-lg-12 col-sm-12">
                <div class="card">
                    <div class="card-header border-0">
                        <div>
                            <h4 class="card-title mb-2">Restaurant Signup Request</h4>
                        </div>
                    </div>
                    <div id="app">
                                    ...
                                    <table id="example5" class="display mb-4 dataTablesCard">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><strong class="font-w600 wspace-no">Restaurant</strong></th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="first_td">{{ $restaurant->restaurant_name }}</td>
                                                <td>{{ $restaurant->contact_person }}</td>
                                                <td>{{ $restaurant->email }}</td>                     
                                                <td>{{ $restaurant->location }}</td>
                                                <td>{{ $restaurant->contact_number }}</td>
                                                <td class="last_td" style="padding: 2px;text-align: center;">
                                                   <a href=""> 
                                                    <a class="btn btn-primary table_btn" href="approve_restaurant/{{ $restaurant->restaurant_id }}">
                                                        Accept
                                                    ...
                                                    <a class="btn btn-danger light table_btn" href="reject_restaurant/{{ $restaurant->restaurant_id }}">
                                                        Reject
                                                        <!-- <svg  width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
